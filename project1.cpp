...
int main()
{
  ...
  double x[n]; //Storing the x-values
  double u[n]; //Storing the true values of u in the x-points
  std::ofstream myfile;
  ...
  //Problem 7
  double a[n-2]; //Stores the sub-diagonal values
  double b[n-2]; //Stores the main-diagonal values
  double c[n-2]; //Stores the super-diagonal values
  double g[n-2]; //Stores the g values for problem 7a
  double g_special[n-2]; //Stores the g values for problem 9b
  ...
  double v[n-2]; //Stores the approx solution
